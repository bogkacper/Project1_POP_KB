...
label_lista_obiektow_klient.grid(row=0, column=3,columnspan=1)
listbox_lista_obiektow_klient=Listbox(ramka_lista_obiektow, width=40, height=10)
listbox_lista_obiektow_klient.grid(row=1, column=3, columnspan=1)
...
label_lista_obiektow_klient=Label(ramka_lista_obiektow, text="Lista użytkowników")
label_lista_obiektow_klient.grid(row=0, column=5,columnspan=1)
listbox_lista_obiektow_klient=Listbox(ramka_lista_obiektow, width=40, height=10)
listbox_lista_obiektow_klient.grid(row=1, column=5, columnspan=1)
button_pokaz_szczegoly_obiektu_klient=Button(ramka_lista_obiektow, text='Pokaż szczegóły')
